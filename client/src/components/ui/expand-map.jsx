...
export function LocationMap({
  ...
  coordinates = "51.5095° N, 0.1410° W",
  className,
}) {
      ...
      >
          ...
          {isExpanded && (
            ...
            >
              ...
              >
                ...
                >
                  {/* Changed marker fill to luxury champagne */}
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="var(--champagne, #C9A96E)" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            <div className="relative">
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                {/* Map Icon SVG - Changed color to champagne */}
                <motion.svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
                  ...
                  className="text-[var(--champagne,#C9A96E)]"
                  animate={{
                    filter: isHovered
            ...
            {/* Status indicator - Changed color to champagne */}
            <motion.div
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full bg-[var(--champagne,#C9A96E)]" />
          ...
          <div className="space-y-1">
            ...
            {/* Animated underline - Changed color to champagne */}
            <motion.div
              className="h-px bg-gradient-to-r from-[var(--champagne)]/50 via-[var(--champagne-lt)]/30 to-transparent"

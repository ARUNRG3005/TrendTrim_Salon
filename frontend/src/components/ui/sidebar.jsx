...
const SidebarMenuSub = React.forwardRef(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5 list-none p-0 m-0",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
...
const SidebarMenuSubItem = React.forwardRef(({ ...props }, ref) => <li ref={ref} className="list-none" {...props} />)
